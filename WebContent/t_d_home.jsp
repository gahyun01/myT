			...
			<div class="card">
				...
				<div class="cardhalf">
					<div class="prfbox">
						...
						<a href="t_diary.jsp" class="prfid"><%= user_id %></a>
					</div>
					<div class="imgslider">			
					...
					<div class="iconmom">
						<div class="iconblock">
							<div>
								<img src="img/heart.png" id="heart"/> 1.3k
							</div>
							<div>
								<img src="img/share.png" id="share"/> 1k
							</div>
						</div>
						<div>
							<img src="img/bookmark.png" id="bmark"/> 2.5k
						</div>
					</div>
				</div>
				<!-- 오른쪽 큰 네모 -->
