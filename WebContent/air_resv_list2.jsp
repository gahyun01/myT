  ...
  <div id="bg2">
    <div>
      <table border="0" cellspacing="0">
        <tr>
          <td class="title" style="border-top-left-radius: 10px">항공 예약번호</td>
          ...
          <td class="title" style="border-top-right-radius: 10px">취소</td>
        </tr>
        <tr>
          ...
          <td class="cont cont2"><input type="checkbox" name=“cancel” value="1"></td>
        </tr>
      </table><br><br>
    </div>
    <div>
