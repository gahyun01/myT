...
//		$('#btn_insert2').prop('disabled', true);
		$('#btn_insert').show();
		$('#btn_insert2').show();
	}
...
//	//	사용시간 - 버튼 누룰 때
//	$('#btn_minus_h').click(function(){
//		//	Number로 숫자타입으로 바꾸지 않으면 숫자가 수정되는게 아니라 뒤에 추가가 됨
//		var i = Number($('#hour_num').val());
//
//		if(i > 2){
//			$('#hour_num').val(Number(i-1));
//		}
//	});
//
//	// 사용시간 + 버튼 누룰때
//	$('#btn_plus_h').click(function(){
//		//	Number로 숫자타입으로 바꾸지 않으면 숫자가 수정되는게 아니라 뒤에 추가가 됨
//		var hour_num = Number($('#hour_num').val());
//		
...
//
//		if(hour_num < 12){
//			$('#hour_num').val(Number(hour_num+1));
//		}
//		else{
...
//	
//	// 탑승인원 - 버튼 누룰 때
//	$('#btn_minus_p').click(function(){
//		//	Number로 숫자타입으로 바꾸지 않으면 숫자가 수정되는게 아니라 뒤에 추가가 됨
//		var i = Number($('#per_num').val());
//
//		if(i > 1){
//			$('#per_num').val(Number(i-1));
//		}
//	});
//	
//	
//	//	차량 클릭시
//	$('#car_info1').click(function(){
//		//$(this).fadeToggle();
//	});
