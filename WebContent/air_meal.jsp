  ...
  <form>
    ...
    <div id="bgtop">
      <div id="choice">
        ...
        <div class="choice0 choice2 choice_not"><a class="air_menu" href="air_resv.jsp">예약조회</a></div>
        <div class="choice0 choice2">기내식 신청</div>
      ...
      <div>
        <table border="0" cellspacing="0">
          <tr>
            ...
            <td class="title" style="border-top-right-radius: 10px">기내식 신청</td>
          </tr>
          <tr>
