...
%>          
      ...
      <!-- 다음 페이지로 넘어가는 버튼-->
      <div class="div_btn">
        <button type="button" class="btn btn_air_list" id="btn_next" disabled><%= btn %></button>
        <div class="div_amount"><div class="div_amount1">예상 결제금액</div><div class="div_amount2" id="amount_dept"></div><div class="div_amount3">원</div></div>
      </div>
      <div class="line"></div>
