    ...
    <div id="car">
     ...
     <div class='car' id='car_insert'>
      ...
      <div class='div_1'  style='margin-top: 30px;'><label class='lbl_title'>도 시</label>
        <div class="air_0 air_city2" id="city_arrv"><ul><li id="city_arrv2">서울/인천</li><li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="img/city.png" class="img_size"></li></ul></div>
      <input type='hidden' class='hidden' name='hidden_city2' id='hidden_city2' value='서울/인천'></div>
