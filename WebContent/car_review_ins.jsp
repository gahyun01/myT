...
<body>
 ...
 <section>
   ...
   <div id="bgtop_car"> <!-- choice / search -->
    ...
    <form action="car_review_ins2.jsp" onsubmit='return check_input()'>
      <div id="search_review">
        <div class="search">
          ...
          <div class="search2_title" style="margin-left: 95px">작성자</div><div class="search2_title" style="margin-left: 75px">검색어</div>
           <input type='hidden' class='hidden' name='hidden_city' id='hidden_city' value='서울'> 
           <input type='hidden' class='hidden' name='hidden_id' id='hidden_id' value='<%= user_id %>' > 
        </div>
        <div class="search3">
          <div class="air_0 air_city" id="city_dept"><ul><li id="city_dept2">서울</li><li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="img/city.png" class="img_size"></li></ul></div>
  ...
  <div id="bg_car">
    <div id="car">
     ...
     <div class='car' id='car_insert'>
      <!-- div id='div_title' ><label class='lbl_title'>제   목</label><input type="text" name='cont_title' placeholder="제목을 입력해주세요." maxlength='30' id='input_title' ></div-->
      <div class='div_1'  style='margin-top: 30px;'><label class='lbl_title'>도 시</label>
        <div class="air_0 air_city2" id="city_arrv"><ul><li id="city_arrv2">서울</li><li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="img/city.png" class="img_size"></li></ul></div>
      <input type='hidden' class='hidden' name='hidden_city2' id='hidden_city2' value='서울'></div>
      <div class='div_1'><label class='lbl_title'>차 량</label>
          <select name='car_gbn2' class='car_gbn'>
          	<option value='5' >5인승</option>
			<option value='8' >8인승</option><option value='12' >12인승</option>
          </select>
      </div>
      <div id='div_title'><label class='lbl_title'>제 목</label><input type="text" name='cont_title' placeholder="제목을 입력해주세요." maxlength='30' id='input_title' ></div>
      <div id='div_textarea' ><!--label class='lbl_title'> </label--><textarea class='textarea' id='textarea' name='cont_text' placeholder="내용 입력해주세요." cols='40' rows='8' maxlength='500' ></textarea></div>
    <div class='bg3' ><button  type="submit" class="btn_insert btn_insert2" id="btn_insert2" >저장</button></div>
    </form>
    </div><!-- car_insert -->
    </div>
    <!--div>
