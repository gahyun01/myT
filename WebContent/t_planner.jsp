...
<%@ page import = green.myT.dto.Planner %>
<%@ page language="java" contentType="text/html;charset=utf-8" pageEncoding="utf-8" %>
<%@ page import="java.util.*"%>
<%@ page import="java.text.SimpleDateFormat"%>

<!-- <%
      ArrayList<Planner> plannerMainList = (ArrayList<Planner>)request.getAttribute("plannerMainList");
 ...
 <jsp:include page="banner.jsp" />
  ...
  <form>
    ...
    <div class="mainp">
      ...
      <!-- plannerMainList -->
      <%
          if(plannerMainList != null && listCount > 0){
      %>

      <div class="pplanner">
        <%
            for(int i = 0; i < plannerMainList.size(); i++){
        %>
        ...
        <div class="splanner">
          <div class="pinfo">
            ...
            <div class="position"><%= user_name %></div>
            <div class="title"><%= plan_name %></div>
