...
CREATE TABLE `hotel_photo` (
  `in_no` int NOT NULL,
  `ex_no` int NOT NULL,
  `ex_detail` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `ex_img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  KEY `in_no_idx` (`in_no`),
  CONSTRAINT `hp_in_no` FOREIGN KEY (`in_no`) REFERENCES `hotel` (`in_no`)
