...
CREATE TABLE `plan_detail` (
  `pdet_no` int NOT NULL AUTO_INCREMENT,
  `plan_no` int NOT NULL,
  `pdet_day` date NOT NULL,
  `cl_no` varchar(1) COLLATE utf8mb3_bin DEFAULT NULL,
  `in_no` int DEFAULT NULL,
  `pdet_text` text COLLATE utf8mb3_bin,
  PRIMARY KEY (`pdet_no`),
  KEY `pd_plan_no` (`plan_no`),
  CONSTRAINT `pd_plan_no` FOREIGN KEY (`plan_no`) REFERENCES `planner` (`plan_no`)
