...
--
-- Table structure for table `dutyfr_review`
--

DROP TABLE IF EXISTS `dutyfr_review`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dutyfr_review` (
...
--
-- Dumping data for table `dutyfr_review`
--

LOCK TABLES `dutyfr_review` WRITE;
/*!40000 ALTER TABLE `dutyfr_review` DISABLE KEYS */;
/*!40000 ALTER TABLE `dutyfr_review` ENABLE KEYS */;
UNLOCK TABLES;
