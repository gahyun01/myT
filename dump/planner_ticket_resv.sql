...
CREATE TABLE `ticket_resv` (
  `resv_no` varchar(20) CHARACTER SET utf8 NOT NULL,
  `user_id` varchar(15) CHARACTER SET utf8 NOT NULL,
  `cl_no` varchar(1) CHARACTER SET utf8 NOT NULL,
  `in_no` varchar(20) CHARACTER SET utf8 NOT NULL,
  `visit_date` varchar(8) CHARACTER SET utf8 NOT NULL,
  `tck_anum` int(11) DEFAULT NULL,
  `tck_cnum` int(11) DEFAULT NULL,
  `pay_no` varchar(8) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`resv_no`)
