...
--
-- Table structure for table `car_resv`
--

DROP TABLE IF EXISTS `car_resv`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `car_resv` (
...
--
-- Dumping data for table `car_resv`
--

LOCK TABLES `car_resv` WRITE;
/*!40000 ALTER TABLE `car_resv` DISABLE KEYS */;
/*!40000 ALTER TABLE `car_resv` ENABLE KEYS */;
UNLOCK TABLES;
