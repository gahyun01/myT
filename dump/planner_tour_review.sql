...
CREATE TABLE `tour_review` (
  ...
  `ts_rtime` datetime NOT NULL,
  `ts_rimage` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `ts_rcont` text CHARACTER SET utf8 NOT NULL,
  `ts_rstars` int(11) NOT NULL DEFAULT '5',
  `ts_rc` int(11) DEFAULT '0'
