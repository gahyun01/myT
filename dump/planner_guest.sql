...
CREATE TABLE `guest` (
  ...
  `k_lastnm` varchar(30) COLLATE utf8_bin NOT NULL,
  `k_firstnm` varchar(30) COLLATE utf8_bin NOT NULL,
  `e_lastnm` varchar(30) COLLATE utf8_bin NOT NULL,
  `e_firstnm` varchar(30) COLLATE utf8_bin NOT NULL,
