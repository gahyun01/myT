...
CREATE TABLE `profile` (
  ...
  `pf_nicknm` varchar(20) CHARACTER SET utf8 NOT NULL,
  `pf_pic` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `pf_bg` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `pf_intr` text CHARACTER SET utf8,
